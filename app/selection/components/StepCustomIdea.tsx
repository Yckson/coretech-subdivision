  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-300">Envie seu próprio PDF com a proposta (opcional)</p>
      </div>
      ...
      >
        ...
        <div className="p-4 bg-primary/10 rounded-lg border border-primary/30 flex items-start gap-3">
          ...
          <p className="text-sm text-gray-300">
            <span className="text-primary font-semibold">Nota:</span> Envio de PDF é completamente opcional. Se você escolheu artigos no passo anterior, pode pular esta etapa.
          </p>
        </div>
      </motion.div>
    </motion.div>
